...
If no arguments or missing arguments, print:
"Usage: /seed-expense <user_id> <count> <months>

Arguments:
  user_id  — Integer ID of the user to create expenses for
  count    — Number of expenses to generate (e.g., 50)
  months   — Spread expenses across this many past months (e.g., 6)

Example: /seed-expense 1 50 6
  Creates 50 expenses for user #1, spread across the last 6 months

Tips:
  - Run /seed-user first to create a new user
  - Use SELECT id, name, email FROM users to find user IDs"
